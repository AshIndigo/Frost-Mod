...
public class ItemIcePendant extends UtilsItem implements IFrostPowerBooster, IBauble {


	public ItemIcePendant(String modid, String name, String translatedName, CreativeTabs tab) {
